...
const STORAGE_KEY = "dd_onboarding_latency";
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#F0F4F8", position: "relative" }}>
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", padding: "30px 48px 16px" }}>
        <ModuleHero headline="Should you chase the next millisecond?" subtext="Click the chart to set your current p99. Drag the slider to see what faster costs." />
        <ModuleTabs />
        <Calculator
