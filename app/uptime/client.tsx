...
const STORAGE_KEY = "dd_onboarding_uptime";
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#F0F4F8", position: "relative" }}>
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", padding: "30px 48px 16px" }}>
        <ModuleHero headline="Should you invest in the next nine?" subtext="Click the chart to set where you are today. Drag the slider to see what the next level costs." />
        <ModuleTabs />
        <Calculator
