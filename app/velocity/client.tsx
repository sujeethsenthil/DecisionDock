...
const STORAGE_KEY = "dd_onboarding_velocity";
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#F0F4F8", position: "relative" }}>
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", padding: "30px 48px 16px" }}>
        <ModuleHero headline="Should you ship faster?" subtext="Click the chart to set your deploy cadence. Drag the slider to see what the next level costs." />
        <ModuleTabs />
        <Calculator
